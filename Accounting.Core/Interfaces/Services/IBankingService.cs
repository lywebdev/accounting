...
{
    Task<IReadOnlyList<BankTransaction>> GetAsync(DateOnly? from, DateOnly? to, bool? isMatched, string? searchTerm, decimal? amountMin, decimal? amountMax, CancellationToken cancellationToken = default);
